[![Build Status](https://travis-ci.com/makut/game_life.svg?branch=master)](https://travis-ci.com/makut/game_life)
...
* `pytest-cov` и `codecov` для автоматической загрузки данных о покрытии проекта (для локального запуска не требуется).
